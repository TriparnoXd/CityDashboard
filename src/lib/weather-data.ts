...
const londonData: WeatherData = {
  ...
  imageUrl: 'https://picsum.photos/seed/london-eye/600/400'
};
...
const newYorkData: WeatherData = {
  ...
  imageUrl: 'https://picsum.photos/seed/empire-state-building/600/400'
};
...
const tokyoData: WeatherData = {
  ...
  imageUrl: 'https://picsum.photos/seed/senso-ji-temple/600/400'
};
...
const parisData: WeatherData = {
  ...
  hourlyForecast: [
    ...
    { time: '3 PM', temperature: 19, weatherConditions: 'Sunny' },
    { time: '4 PM', temperature: 18, weatherConditions: 'Sunny' },
    { time: '5 PM', temperature: 18, weatherConditions: 'Sunny' },
    { time: '6 PM', temperature: 17, weatherConditions: 'Partly cloudy' },
    { time: '7 PM', temperature: 16, weatherConditions: 'Partly cloudy' },
    { time: '8 PM', temperature: 15, weatherConditions: 'Clear' },
    { time: '9 PM', temperature: 15, weatherConditions: 'Clear' },
    { time: '10 PM', temperature: 14, weatherConditions: 'Clear' },
  ],
  dailyForecast: [
  ...
  imageUrl: 'https://picsum.photos/seed/louvre-museum/600/400'
};
...
const berlinData: WeatherData = {
    ...
    hourlyForecast: [
        ...
        { time: '3 PM', temperature: 17, weatherConditions: 'Cloudy' },
        { time: '4 PM', temperature: 16, weatherConditions: 'Cloudy' },
        { time: '5 PM', temperature: 16, weatherConditions: 'Light rain' },
        { time: '6 PM', temperature: 15, weatherConditions: 'Light rain' },
        { time: '7 PM', temperature: 14, weatherConditions: 'Cloudy' },
        { time: '8 PM', temperature: 13, weatherConditions: 'Cloudy' },
        { time: '9 PM', temperature: 13, weatherConditions: 'Cloudy' },
        { time: '10 PM', temperature: 12, weatherConditions: 'Cloudy' },
    ],
    dailyForecast: [
    ...
    imageUrl: 'https://picsum.photos/seed/reichstag-building/600/400'
};
...
const moscowData: WeatherData = {
    ...
    hourlyForecast: [
        ...
        { time: '3 PM', temperature: 11, weatherConditions: 'Light rain' },
        { time: '4 PM', temperature: 10, weatherConditions: 'Rain' },
        { time: '5 PM', temperature: 10, weatherConditions: 'Rain' },
        { time: '6 PM', temperature: 9, weatherConditions: 'Rain' },
        { time: '7 PM', temperature: 9, weatherConditions: 'Cloudy' },
        { time: '8 PM', temperature: 8, weatherConditions: 'Cloudy' },
        { time: '9 PM', temperature: 8, weatherConditions: 'Cloudy' },
        { time: '10 PM', temperature: 7, weatherConditions: 'Cloudy' },
    ],
    dailyForecast: [
...
const beijingData: WeatherData = {
    ...
    hourlyForecast: [
        ...
        { time: '3 PM', temperature: 23, weatherConditions: 'Haze' },
        { time: '4 PM', temperature: 22, weatherConditions: 'Haze' },
        { time: '5 PM', temperature: 22, weatherConditions: 'Haze' },
        { time: '6 PM', temperature: 21, weatherConditions: 'Haze' },
        { time: '7 PM', temperature: 20, weatherConditions: 'Cloudy' },
        { time: '8 PM', temperature: 20, weatherConditions: 'Cloudy' },
        { time: '9 PM', temperature: 19, weatherConditions: 'Cloudy' },
        { time: '10 PM', temperature: 18, weatherConditions: 'Cloudy' },
    ],
    dailyForecast: [
    ...
    imageUrl: 'https://picsum.photos/seed/great-wall-of-china/600/400'
};
...
const sydneyData: WeatherData = {
    ...
    hourlyForecast: [
        ...
        { time: '3 PM', temperature: 21, weatherConditions: 'Sunny' },
        { time: '4 PM', temperature: 20, weatherConditions: 'Sunny' },
        { time: '5 PM', temperature: 19, weatherConditions: 'Clear' },
        { time: '6 PM', temperature: 18, weatherConditions: 'Clear' },
        { time: '7 PM', temperature: 17, weatherConditions: 'Clear' },
        { time: '8 PM', temperature: 17, weatherConditions: 'Clear' },
        { time: '9 PM', temperature: 16, weatherConditions: 'Clear' },
        { time: '10 PM', temperature: 16, weatherConditions: 'Clear' },
    ],
    dailyForecast: [
    ...
    imageUrl: 'https://picsum.photos/seed/sydney-harbour-bridge/600/400'
};
...
const cairoData: WeatherData = {
    ...
    hourlyForecast: [
        ...
        { time: '3 PM', temperature: 36, weatherConditions: 'Sunny' },
        { time: '4 PM', temperature: 35, weatherConditions: 'Sunny' },
        { time: '5 PM', temperature: 34, weatherConditions: 'Sunny' },
        { time: '6 PM', temperature: 33, weatherConditions: 'Clear' },
        { time: '7 PM', temperature: 32, weatherConditions: 'Clear' },
        { time: '8 PM', temperature: 31, weatherConditions: 'Clear' },
        { time: '9 PM', temperature: 30, weatherConditions: 'Clear' },
        { time: '10 PM', temperature: 29, weatherConditions: 'Clear' },
    ],
    dailyForecast: [
...
const newDelhiData: WeatherData = {
    ...
    hourlyForecast: [
        ...
        { time: '3 PM', temperature: 39, weatherConditions: 'Haze' },
        { time: '4 PM', temperature: 38, weatherConditions: 'Haze' },
        { time: '5 PM', temperature: 37, weatherConditions: 'Haze' },
        { time: '6 PM', temperature: 36, weatherConditions: 'Haze' },
        { time: '7 PM', temperature: 35, weatherConditions: 'Partly cloudy' },
        { time: '8 PM', temperature: 34, weatherConditions: 'Partly cloudy' },
        { time: '9 PM', temperature: 34, weatherConditions: 'Partly cloudy' },
        { time: '10 PM', temperature: 33, weatherConditions: 'Clear' },
    ],
    dailyForecast: [
    ...
    imageUrl: 'https://picsum.photos/seed/lotus-temple/600/400'
};
...
const mumbaiData: WeatherData = {
    ...
    hourlyForecast: [
        ...
        { time: '3 PM', temperature: 31, weatherConditions: 'Rain' },
        { time: '4 PM', temperature: 31, weatherConditions: 'Heavy rain' },
        { time: '5 PM', temperature: 30, weatherConditions: 'Heavy rain' },
        { time: '6 PM', temperature: 30, weatherConditions: 'Heavy rain' },
        { time: '7 PM', temperature: 29, weatherConditions: 'Rain' },
        { time: '8 PM', temperature: 29, weatherConditions: 'Rain' },
        { time: '9 PM', temperature: 29, weatherConditions: 'Rain' },
        { time: '10 PM', temperature: 28, weatherConditions: 'Cloudy' },
    ],
    dailyForecast: [
    ...
    imageUrl: 'https://picsum.photos/seed/bandra-worli-sea-link/600/400'
};
...
const kolkataData: WeatherData = {
    ...
    hourlyForecast: [
        ...
        { time: '3 PM', temperature: 33, weatherConditions: 'Thunderstorm' },
        { time: '4 PM', temperature: 32, weatherConditions: 'Thunderstorm' },
        { time: '5 PM', temperature: 32, weatherConditions: 'Rain' },
        { time: '6 PM', temperature: 31, weatherConditions: 'Rain' },
        { time: '7 PM', temperature: 30, weatherConditions: 'Cloudy' },
        { time: '8 PM', temperature: 30, weatherConditions: 'Cloudy' },
        { time: '9 PM', temperature: 30, weatherConditions: 'Cloudy' },
        { time: '10 PM', temperature: 29, weatherConditions: 'Cloudy' },
    ],
    dailyForecast: [
    ...
    imageUrl: 'https://picsum.photos/seed/howrah-bridge/600/400'
};
...
const chennaiData: WeatherData = {
    ...
    hourlyForecast: [
        ...
        { time: '3 PM', temperature: 35, weatherConditions: 'Partly cloudy' },
        { time: '4 PM', temperature: 34, weatherConditions: 'Partly cloudy' },
        { time: '5 PM', temperature: 34, weatherConditions: 'Partly cloudy' },
        { time: '6 PM', temperature: 33, weatherConditions: 'Partly cloudy' },
        { time: '7 PM', temperature: 32, weatherConditions: 'Cloudy' },
        { time: '8 PM', temperature: 32, weatherConditions: 'Cloudy' },
        { time: '9 PM', temperature: 31, weatherConditions: 'Cloudy' },
        { time: '10 PM', temperature: 30, weatherConditions: 'Cloudy' },
    ],
    dailyForecast: [
...
const bengaluruData: WeatherData = {
    ...
    hourlyForecast: [
        ...
        { time: '3 PM', temperature: 28, weatherConditions: 'Cloudy' },
        { time: '4 PM', temperature: 27, weatherConditions: 'Cloudy' },
        { time: '5 PM', temperature: 27, weatherConditions: 'Light rain' },
        { time: '6 PM', temperature: 26, weatherConditions: 'Light rain' },
        { time: '7 PM', temperature: 25, weatherConditions: 'Cloudy' },
        { time: '8 PM', temperature: 25, weatherConditions: 'Cloudy' },
        { time: '9 PM', temperature: 25, weatherConditions: 'Cloudy' },
        { time: '10 PM', temperature: 24, weatherConditions: 'Cloudy' },
    ],
    dailyForecast: [
    ...
    imageUrl: 'https://picsum.photos/seed/lalbagh-botanical-garden/600/400'
};
...
const hyderabadData: WeatherData = {
    ...
    hourlyForecast: [
        ...
        { time: '3 PM', temperature: 33, weatherConditions: 'Sunny' },
        { time: '4 PM', temperature: 32, weatherConditions: 'Sunny' },
        { time: '5 PM', temperature: 32, weatherConditions: 'Partly cloudy' },
        { time: '6 PM', temperature: 31, weatherConditions: 'Partly cloudy' },
        { time: '7 PM', temperature: 30, weatherConditions: 'Clear' },
        { time: '8 PM', temperature: 30, weatherConditions: 'Clear' },
        { time: '9 PM', temperature: 29, weatherConditions: 'Clear' },
        { time: '10 PM', temperature: 28, weatherConditions: 'Clear' },
    ],
    dailyForecast: [
    ...
    imageUrl: 'https://picsum.photos/seed/golconda-fort/600/400'
};
...
const jaipurData: WeatherData = {
    ...
    hourlyForecast: [
        ...
        { time: '3 PM', temperature: 40, weatherConditions: 'Sunny' },
        { time: '4 PM', temperature: 39, weatherConditions: 'Sunny' },
        { time: '5 PM', temperature: 38, weatherConditions: 'Clear' },
        { time: '6 PM', temperature: 37, weatherConditions: 'Clear' },
        { time: '7 PM', temperature: 36, weatherConditions: 'Clear' },
        { time: '8 PM', temperature: 35, weatherConditions: 'Clear' },
        { time: '9 PM', temperature: 35, weatherConditions: 'Clear' },
        { time: '10 PM', temperature: 34, weatherConditions: 'Clear' },
    ],
    dailyForecast: [
    ...
    imageUrl: 'https://picsum.photos/seed/amer-fort/600/400'
};
